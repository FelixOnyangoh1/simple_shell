...
/**
 * get_history_file - this acquires the history file
 * @info:the parameter struct
 *
 * Return: returns allocated string containing history file
 */
 ...
 * @info:the Structure containing potential arguments. Used for maintaining
 * @buf:the buffer
